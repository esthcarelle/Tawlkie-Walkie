    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connect.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (ActivityCompat.checkSelfPermission(UserSelection.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    {
                        ActivityCompat.requestPermissions(UserSelection.this, new String[]{Manifest.permission.BLUETOOTH_CONNECT}, 2);
                        return ;
                    }
                }
        ...
        listen.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                // Accept connection
                boolean connectSuccess = listenThread.acceptConnect(mBluetoothAdapter, MY_UUID,UserSelection.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                boolean connectSuccess = connectThread.connect(device, MY_UUID,UserSelection.this);
